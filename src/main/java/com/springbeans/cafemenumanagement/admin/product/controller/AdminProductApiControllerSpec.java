...
public interface AdminProductApiControllerSpec {
    ...
    ResponseEntity<ProductSaveResponse> addProduct(@Valid @ModelAttribute ProductSaveRequest request) throws IOException;
    ...
    @PutMapping("/{id}")
    ResponseEntity<ProductSaveResponse> updateProduct(@PathVariable Long id, @Valid @ModelAttribute ProductSaveRequest request) throws IOException;
